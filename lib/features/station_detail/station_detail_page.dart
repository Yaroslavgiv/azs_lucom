...
final _maintenanceInfoProvider = FutureProvider.family<String, String>((ref, number) async {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      AppSecondaryButton(
                        ...
                        onPressed: () async {
                          await showToDialog(context, stationNumber: stationNumber);
                          ref.invalidate(_maintenanceInfoProvider(stationNumber));
                        },
                      ),
                    ],
                  ),
                    ...
                    children: requests
                        .map(
                          (r) => Padding(
                            ...
                            child: GlassCard(
                              onTap: () => showEditRequestDialog(context, ref, r),
                              child: Column(
